...
public class UserDAOTest extends TestCase {
	...
	public void testUser() throws Exception {
		...
		user.setInvestment_account(2);
		user.setSaving_account(1);
		user.setLoan_account(3);
		...
		assertEquals(tUser.getInvestment_account(),2);
		assertEquals(tUser.getSaving_account(),1);
		assertEquals(tUser.getLoan_account(),3);
